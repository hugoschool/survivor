...
func UpdateSkills(db *gorm.DB, user *models.User, input []models.SkillInput) error {
...
func UpdateLocations(db *gorm.DB, user *models.User, input []models.LocationInput) error {
...
func UpdateSectors(db *gorm.DB, user *models.User, input []models.SectorInput) error {
...
func UpdateVideos(db *gorm.DB, user *models.User, input []models.VideoInput) error {
